...
if choice == "Create Task ✅":
	...
	if st.button("Add Task"):
		add_data(task,task_assign,task_status,task_due_date)
	...
	with st.expander("Current Data"):
		...
		clean_df = pd.DataFrame(result,columns=["Task","Assigned","Status","Date"])
	...
	if task_result:
		...
		if st.button("Update Task 👨‍💻"):
			edit_task_data(new_task,new_task_assign,new_task_status,new_task_due_date,task,task_assign,task_status,task_due_date)
